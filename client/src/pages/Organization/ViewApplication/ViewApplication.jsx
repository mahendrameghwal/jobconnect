...
const ViewApplication = () => {
  ...
  return (
    ...
    <section className="container mx-auto p-6 max-md:px-2 font-mono">
    <div className="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
      <div className="w-full overflow-x-auto">
        <table className="w-full">
          <thead>
            <tr className="text-md font-semibold tracking-wide text-left text-gray-200 bg-blue-500 uppercase border-b border-gray-600">
          ...
          <tbody className="bg-white">
            <tr className="text-gray-700">
              ...
              <td className="px-4 py-3 text-xs border">
                <span className="px-1 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> ShortListed </span>
              </td>
            ...
            <tr className="text-gray-700  bg-gray-100">
              ...
              <td className="px-4 py-3 text-xs border">
              <span className="px-4 py-1 font-semibold leading-tightb text-orange-600 bg-yellow-100 rounded-sm"> Pending </span>
            </td>
            ...
            <tr className="text-gray-700 ">
              ...
              <td className="px-4 py-3 text-xs border">
                <span className="px-1 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-sm"> Nnacceptable </span>
              </td>
              <td className="px-4 py-3 text-sm border">6/10/2020</td>
            </tr>
            <tr className="text-gray-700  bg-gray-100">
